...
const Footer = () => {
  ...
  const quickLinks = [
    { name: 'Home', url: '/' },
    { name: 'Top picks', url: '/under-construction' },
  ...
  const legalLinks = [
    ...
    { name: 'Accessibility Statement', url: '/under-construction' },
    { name: 'Imprint', url: '/under-construction' },
  ];

  const followLinks = [
    { name: 'Blog', url: '/under-construction' },
                ...
                <Box>
                  ...
                  <Grid container>
                    <Grid item xs={12} sm={6}>
                      {quickLinks.map((link) => renderLink(link))}
                    </Grid>
                    <Grid item xs={12} sm={6}>
                      {legalLinks.map((link) => renderLink(link))}
                    </Grid>
                  </Grid>
                </Box>
              </Grid>
